...
short_title: series-RTA-10 칼슘 정리
---
...
**Type 2 series-RTA**에서는 근위 세뇨관 기능 자체가 손상되어 citrate가 재흡수되지 않고 소변으로 많이 새어 나간다. 소변에 citrate가 풍부하면 칼슘이 붙잡혀 결정 형성이 억제된다. 그래서 Type 2 RTA는 Type 1에 비해 신결석이 상대적으로 적게 생긴다.
