---
id: hf02-hfref-pathophysiology
title: 박출률감소심부전(HFrEF)에서 심장이 스스로 망가지는 이유는 무엇인가
series: series-HF
level: 3
...
결국 **심장 기능 손상 → 신경호르몬 보상기전 활성화 → 심장·혈관·콩팥의 이차 손상 → 리모델링 → 심장 기능 추가 악화**의 악순환이 형성된다. 이것이 HFrEF가 자연적으로 진행성 경과를 밟는 이유다.
...
보상기전은 일시적 이득을 주지만, **장기 지속이 심장을 망가뜨린다는 역설**을 이해하는 것이 HFrEF 치료 전체의 출발점이다.

영상으로 더 깊이 보고 싶다면:
[▶ 영상으로 보기](https://youtu.be/dL5_4KfuH-I) *(멤버십)*

---
선행: [[hf-classification]]
연관: [[hf04-natural-history]]
다음: [[hf03-hfpef-pathophysiology]]
