...
1. 심전도(ECG)
2. 고감도 심장 트로포닌(high-sensitivity cardiac troponin) 측정
3. 신체 진찰(physical examination)
4. 임상 병력(clinical history)
5. 활력 징후(vital signs): 혈압, 심박수 포함
...
영상으로 더 깊이 보고 싶다면:
[▶ 영상으로 보기](https://youtu.be/Bk1oDG-k1Mo) *(멤버십)*
