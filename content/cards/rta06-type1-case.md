...
1) 호흡 보상 확인: 예상 PCO₂ = HCO₃⁻ + 15 → 실측값과 대략 일치. 적절한 호흡성 보상이 이루어지고 있다.
...
확진을 위해서는 산 부하 검사(NH₄Cl test)가 필요하다. 이 단계까지는 **Type 1 RTA의 가능성이 높은 상태**로 평가하는 것이 적절하다.
...
**저칼륨혈증 + 요 citrate 감소 + 신석회화**가 함께 있으면 Type 1 RTA를 우선 고려한다. 반복되는 신결석 환자에서 기저 원인으로 RTA를 빠뜨리지 말 것.

영상으로 더 깊이 보고 싶다면:
[▶ 영상으로 보기](https://youtu.be/iYfPjoBYwT4) *(멤버십)*

---
선행: [[rta05-type1-mechanism]]
연관: [[rta07-type1-voltage]]
다음: [[rta08-type4]]
