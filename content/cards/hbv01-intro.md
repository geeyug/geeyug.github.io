...
B형간염은 약을 먹으면 낫는 병이 아닌가. 다른 감염 질환처럼 항바이러스제로 바이러스를 없애면 되는 것이 아닌가. 이 직관이 HBV에서는 통하지 않는다. 이유는 바이러스의 특성에 있다.

## ❷ HBV가 완치되기 어려운 이유는 무엇인가

HBV는 DNA 바이러스다. 간세포에 감염되면 바이러스 DNA가 세포 핵 안으로 들어간다. 그곳에서 cccDNA라는 형태로 안정적으로 머물거나, 숙주 간세포의 유전체(genome) 안으로 통합(integration)된다.

이 상태에서는 항바이러스제가 혈액 속의 바이러스 복제는 억제할 수 있어도, 핵 안의 cccDNA와 통합된 서열을 제거할 수 없다. 즉, 약을 끊으면 언제든 다시 복제가 시작될 수 있다. 이것이 만성 B형간염에 완치(complete cure)가 없는 이유다.
...
연관: [[hbv-chronic-course]], [[hbv-antigens]]
다음: [[hbv-marker-timeline]]
